...
local function open_capture_buffer(title, on_save, initial_lines)
  ...
  vim.keymap.set("n", "<C-c><C-c>", "<Cmd>w<CR>", { buffer = buf, silent = true, desc = "Save and close capture buffer" })
  vim.keymap.set("i", "<C-c><C-c>", "<Esc><Cmd>w<CR>", { buffer = buf, silent = true, desc = "Save and close capture buffer" })
  
  vim.keymap.set("n", "<Esc>", "<Cmd>q<CR>", { buffer = buf, silent = true, desc = "Close capture buffer without saving" })
